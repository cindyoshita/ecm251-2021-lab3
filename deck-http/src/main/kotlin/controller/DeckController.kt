...
class DeckController{
    ...
    public fun drawCard() : Card {
        ...
        val valorDaCarta = cards_resposta["cards"] as JSONArray
        val primeira_carta = valorDaCarta[0] as JSONObject
        return Card(
            primeira_carta["suit"] as String,
            primeira_carta["value"] as String,
            primeira_carta["image"] as String
        )
    }
}